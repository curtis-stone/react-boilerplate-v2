...
const CLIENT = {
  ...
  production: "AfD4wttpRp3kzvJ4n9VGlCZWbD8BRc_kkA6YeR71wkWqSWWKxvEROdH-4fWkOpAceTTZl5LWv16lUF5g",
};
...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Strength Program",
          amount: {
            currency_code: "USD",
            value: 0.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/strength.PNG" />
              <h2>Items: 6Percent Strength Program</h2>
              <h2>Total checkout Amount: $39.99</h2>
            </div>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Strength (Gym) Guide"
            ...
            <div>
              ...
              <Link
                ...
                to="/images/6p-strength-program.pdf"
                target="_blank"
                download
              >
                Download Now
