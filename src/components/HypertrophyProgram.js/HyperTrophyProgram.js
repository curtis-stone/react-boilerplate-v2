...
import HypertrophyProgramPaypalButton from "./HypertrophyProgramPaypalButton";

class HypertrophyProgram extends React.Component {
  state = {
    showPaypal: false,
  };
  ...
  render() {
    ...
    if (showPaypal) {
      return <HypertrophyProgramPaypalButton />;
    } else {
      return (
        <div>
          <SubHeader />
          <div className="info-grid-container">
            <div className="info-container">
              <div>
                <img className="info-cover" src="./images/hypertrophy.PNG" />{" "}
              </div>

              <div className="info-description">
                <h1 className="info-title">6Percent Hypertrophy Program</h1>
                <div className="info-details">
                  <h3>
                    {" "}
                    The Signature 12 Week E-Book dedicated to maximizing gains
                    in both Muscle Tone and Mass. Complete with Ab-Generator Web
                    App, Nutrition Guide, Tips, Meal Planner, and Food List.{" "}
                    <br/>
                    <i style={{ color: "grey" }}>
                      {" "}
                  ...
                  <ul>
                    <li>
                      ...
                      in Bench Press and Squat, and applying the foundational
                      strength workouts to build for a succesful program.
                    </li>
                    <li>
...
export default HypertrophyProgram;
