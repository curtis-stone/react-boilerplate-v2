...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Hypertrophy Program",
          amount: {
            currency_code: "USD",
            value: 39.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/hypertrophy.PNG" />
              <h2>Items: 6Percent Hypertrophy Program</h2>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Hypertrophy (Gym) Guide"
              className="paypal-image"
              src="./images/hypertrophy.PNG"
            />
            <div>
              <p>
                <i>
              ...
              <Link
                ...
                to="/images/6p-hypertrophy-program.pdf"
                target="_blank"
                download
              >
                Download Now
