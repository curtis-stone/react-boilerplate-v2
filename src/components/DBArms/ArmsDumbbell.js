...
import ArmsDumbbellPaypalButton from "./ArmsDumbbellPaypalButton";

class ArmsDumbbell extends React.Component {
  state = {
    showPaypal: false,
  };
  ...
  render() {
    ...
    if (showPaypal) {
      return <ArmsDumbbellPaypalButton />;
    } else {
      return (
        <div>
          <SubHeader />
          <div className="info-grid-container">
            <div className="info-container">
              <div>
                <img className="info-cover" src="./images/db-arms.PNG" />{" "}
              </div>

              <div className="info-description">
                <h1 className="info-title">
                  Arm Day Workout Package (Dumbbell)
                </h1>
                <div className="info-details">
                  <h3>
                    {" "}
                    6 Workout E-Book focused on training the muscular components
                    of the upper body while only using dummbbells. Complete with
                  ...
                  <ul>
                    <li>
                      Workouts consist of unique upper extremity push and pull
                      exercises that incorporate dynamic movements with an
                      emphasis on progressive overload. <br />{" "}
                      <i>
                        Ex. Examples: Dumbbell Presses, Dumbbell Pulls, Dumbbell
                        Super Sets
                      </i>
                    </li>
                    <li>
