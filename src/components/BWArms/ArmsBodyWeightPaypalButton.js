...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Arms Workout Package (Body Weight)",
          amount: {
            currency_code: "USD",
            value: 19.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/bw-arms.PNG" />
              <h2>Items: 6Percent Arms Workout Package (Body Weight)</h2>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Arms Body Weight Guide"
              className="paypal-image"
              src="./images/bw-arms.PNG"
            />
            <div>
              <p>
                <i>
              ...
              <Link
                ...
                to="/images/6p-arms-bw-package.pdf"
                target="_blank"
                download
              >
                Download Now
