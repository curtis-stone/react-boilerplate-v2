...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Full Body Workout Package (Dumbbell)",
          amount: {
            currency_code: "USD",
            value: 19.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/db-fullbody.PNG" />
              <h2>Items: 6Percent Full Body Workout Package (Dumbbell)</h2>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Full Body (Dumbbell) Guide"
              className="paypal-image"
              src="./images/db-fullbody.PNG"
            />
            <div>
              <p>
                <i>
              ...
              <Link
                ...
                to="/images/6p-fullbody-db-package.pdf"
                target="_blank"
                download
              >
                Download Now
            ...
            <div className="messages">
              <p>Now you're all set, let's get those gains!</p>
            </div>
