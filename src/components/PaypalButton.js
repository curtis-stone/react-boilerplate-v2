 ...
 render() {
   ...
   return (
     <div className="main">
       ...
       {paid && (
         <div className="main">
           <img alt="Mercedes G-Wagon" className="program-cover" src="./images/strength-program.pdf" />
           <h2>
             ...
             <span role="img" aria-label="emoji">
               ...
               😉
                ...
                <p>Problem with your purchase? email us at: 6PercentFitness@Gmail.com or visit the help page!</p>
