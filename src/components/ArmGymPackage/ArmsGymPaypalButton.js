...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Arms Package (Gym)",
          amount: {
            currency_code: "USD",
            value: 19.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/g-arms.PNG" />
              <h2>Items: 6Percent Arms Workout Package (Gym) </h2>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Arms (Gym) Guide"
              className="paypal-image"
              src="./images/g-arms.PNG"
            />
            <div>
              <p>
                <i>
              ...
              <Link
                ...
                to="/images/6p-arms-gym-package.pdf"
                target="_blank"
                download
              >
                Download Now
