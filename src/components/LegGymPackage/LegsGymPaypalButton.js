...
class PaypalButton extends React.Component {
  ...
  createOrder = (data, actions) => {
    return actions.order.create({
      purchase_units: [
        {
          description: +"6Percent Legs Package (Gym)",
          amount: {
            currency_code: "USD",
            value: 19.99,
          },
    ...
    return (
      <div className="paypal-styles">
        ...
        {showButtons && (
          <div>
            <div>
              <img className="paypal-image" src="./images/g-legs.PNG" />
              <h2>Items: 6Percent Legs Workout Package (Gym) </h2>
        ...
        {paid && (
          <div className="paypal-styles">
            <img
              alt="Cover of 6P Legs (Gym) Guide"
              className="paypal-image"
              src="./images/g-legs.PNG"
            />
            <div>
              <p>
                <i>
              ...
              <Link
                ...
                to="/images/6p-legs-gym-package.pdf"
                target="_blank"
                download
              >
                Download Now
